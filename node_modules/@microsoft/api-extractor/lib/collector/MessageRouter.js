...
class MessageRouter {
    ...
    static buildJsonDumpObject(input) {
            ...
            case 'object':
                if (Array.isArray(input)) {
                    ...
                    for (const element of input) {
                        // tslint:disable-next-line:no-any
                        const serializedElement = MessageRouter.buildJsonDumpObject(element);
                ...
                for (const key of Object.getOwnPropertyNames(input)) {
                    ...
                    // tslint:disable-next-line:no-any
                    const serializedValue = MessageRouter.buildJsonDumpObject(value);

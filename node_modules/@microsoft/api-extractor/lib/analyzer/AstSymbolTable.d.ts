...
export declare class AstSymbolTable {
    ...
    constructor(program: ts.Program, typeChecker: ts.TypeChecker, packageJsonLookup: PackageJsonLookup, bundledPackageNames: Set<string>, messageRouter: MessageRouter);
    /**

...
class ApiDeclaredItem extends ApiDocumentedItem_1.ApiDocumentedItem {
    ...
    constructor(options) {
        ...
        this._excerptTokens = options.excerptTokens.map(x => {
            const canonicalReference = x.canonicalReference === undefined ? undefined :
                DeclarationReference_1.DeclarationReference.parse(x.canonicalReference);
            return new Excerpt_1.ExcerptToken(x.kind, x.text, canonicalReference);
        });
